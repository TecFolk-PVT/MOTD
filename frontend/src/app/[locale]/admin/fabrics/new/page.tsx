...
export default function NewFabricPage() {
  ...
  const [formData, setFormData] = useState<FabricFormData>({
    ...defaultFabricForm(),
    // Pre-fill with a dummy but valid ObjectId (24 hex chars)
    listedByStore: "67a1b2c3d4e5f6a7b8c9d001",
  });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(err.message || "Failed to create fabric");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Add a new fabric to the catalog
        </p>
      </div>
      {error && (
