        ...
        <div className="bg-(--bg-page) min-h-screen pt-20 pb-12">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase text-(--color-grey-muted) mb-6">
                    <Link href="/fabrics/fabricStore" className="hover:text-black transition">
                        {labels.fabrics}
                    </Link>
                    <span>/</span>
                    <span className="text-black">{formatMaterialLabel(fabric.material, locale)}</span>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        {fabric.tag && (
                            <span
                                className={`inline-block text-white text-[10px] uppercase tracking-[0.2em] px-2 py-1 ${fabric.tagColor || "bg-black"}`}
                            >
                                {fabric.tag}
                            </span>
                        )}
