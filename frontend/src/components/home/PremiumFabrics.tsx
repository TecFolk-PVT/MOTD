                ...
                {filteredItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={`/fabrics/${item.slug}`}
                        className="block bg-(--bg-page) border border-(--color-border) rounded-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 h-full flex-col hover:cursor-pointer"
                      >
                        <div className="aspect-9/9 relative overflow-hidden rounded-t-lg">
                          <img
                            src={imageUrl}
                          ...
                          {item.tag && (
                            <div className="absolute top-2 xs:top-3 left-2 xs:left-3 z-10">
                              <span
                                className={`bg-black text-white px-1.5 xs:px-2 py-0.5 xs:py-1 text-[8px] xs:text-[10px] uppercase whitespace-nowrap [font-family:var(--font-ui)] tracking-[0.24em] font-normal`}
                              >
                                {item.tag}
                              </span>
                            </div>
